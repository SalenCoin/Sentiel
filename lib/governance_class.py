...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to salend "gobject list" output
    ...
    def salend_serialise(self):
        import salenlib
        return salenlib.SHIM_serialise_for_salend(self.serialise())
