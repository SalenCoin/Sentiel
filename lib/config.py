...
sentinel_cfg = SalenConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_salend_proto_version_with_sentinel_ping = 70207


def get_salen_conf():
    home = os.environ.get('HOME')

    salen_conf = os.path.join(home, ".salencore/salen.conf")
    if sys.platform == 'darwin':
        salen_conf = os.path.join(home, "Library/Application Support/SalenCore/salen.conf")

    salen_conf = sentinel_cfg.get('salen_conf', salen_conf)
